...
export default async function MatchControllerPage({params,searchParams}:{params:Promise<{id:string}>;searchParams:Promise<Record<string,string|string[]|undefined>>}) {
  ...
  return <ControllerMatch context={data as any} initialScoring={scoringWithHistory} nextMatch={nextMatch as any} webUrl={WEB_URL} message={ok} errorMessage={errorMessage}/>;
}
