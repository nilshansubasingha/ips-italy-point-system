-- IPS Project 5.8.5 — resolve managed account profile scope from role grants first.
-- This allows a City Admin to manage a Team Admin account in the same City even
-- when that Team Admin account is not linked to a player profile.
