-- IPS Project 6.3 — expose active-player profile images in scorer context.
-- Only URL metadata is added; the Controller still loads at most the three active-player thumbnails.
